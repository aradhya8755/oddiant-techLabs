                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">info@oddianttechlabs.com</p>
                        <p className="text-gray-400">careers@oddianttechlabs.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">Oddiant Techlabs LLP</p>
